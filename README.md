...
```
    ...
    | propg | Cria uma propriedade implementada automaticamente do tipo somente leitura, com um acessador set particular |
    | sim | Cria uma declaração de método principal static int |
